...
const blackCardsData = [
    ...
    { es: "El feminismo moderno arruinó _.", pick: 1 }, { es: "¿Qué es lo que esconde el Papa? _.", pick: 1 },
    { es: "Mi vida sexual es _ y _.", pick: 2 }, { es: "Para mi próximo truco, sacaré un _ de mi _.", pick: 2 },
    ...
    { es: "La peor parte de ser adulto es _.", pick: 1 }, { es: "La nueva ley prohíbe _ en público.", pick: 1 },
    { es: "Mi tatuaje secreto dice ' _ '.", pick: 1 }, { es: "¿Qué le regalé a mi suegra por error? _.", pick: 1 },
    { es: "El 2020 fue malo, pero al menos no tivemos _.", pick: 1 }, { es: "Mi sabor de helado favorito es _.", pick: 1 },
    { es: "La nueva canción del verano se llama ' _ '.", pick: 1 }, { es: "La cura para la resaca es _.", pick: 1 },
    ...
    { es: "Cuidado con _! O te volveras puto, no gay, PUTO!.", pick: 1 }, { es: "Salí del boliche y pisé _.", pick: 1 },
    { es: "En vez de bizcochos, la panadería ahora vende _.", pick: 1 }, { es: "La nueva medida del BROU es _.", pick: 1 },
    { es: "El Pepe Mujica dijo que lo único que le falta es _.", pick: 1 }, { es: "El asado del domingo se arruinó por _ y _.", pick: 2 },
    ...
    { es: "Lo único peor que el CTI de COVID es _ y _.", pick: 2 }, { es: "Una paja triste no es triste sin _.", pick: 1 },
    ...
    { es: "Se suspende el fútbol por _.", pick: 1 }, { es: "¿Cuál es mi mayor defecto? _.", pick: 1 },
    ...
    { es: "El plan perfecto para el domingo: _ con _.", pick: 2 }, { es: "Mi suegra me cocinó _ con _.", pick: 2 },
    { es: "Lo único más lento que un trámite del BPS es _ y _.", pick: 2 }, { es: "La nueva moda en Pocitos es _ y _.", pick: 2 },
    { es: "El clásico se define por _ y _.", pick: 2 }, { es: "Me tomé un bondi equivocado y terminé en _ con _.", pick: 2 },
    { es: "La UDELAR ahora tiene una carrera de 'Licenciatura en _ y _'.", pick: 2 }, { es: "El secreto de una buena pascualina es _ y _.", pick: 2 },
    { es: "Este país no avanza por culpa de _ y _.", pick: 2 }
];

const whiteCardsData = [
    { es: "Eloy" }, { es: "Esclavitud de minorías" }, { es: "Huevos de codorniz lanzados con mucha fuerza" }, { es: "El gobierno" },
    ...
    { es: "Las buenas drogas" }, { es: "Estar muy fumado" }, { es: "Estar muy borracho" },
    ...
    { es: "Una secta" }, { es: "Decir 'provecho' en el baño" }, { es: "El metaverso" }, { es: "Un NFT de un mono" }, { es: "BATMAN!!" },
    { es: "El ano de Batman" }, { es: "Nicolas Cage" }, { es: "Un velociraptor vestido de cura" }, { es: "Hacer caca en el trabajo" },
    { es: "Un vegano que come carne a escondidas" }, { es: "El olor a humedad" }, { es: "Poner los cuernos" },
    ...
    { es: "El perro del vecino a las 3 AM" }, { es: "Una paloma comiéndose un hot dog" }, { es: "El holocausto nuclear" },
